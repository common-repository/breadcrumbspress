    ...
    <div class="d4p-setup-wrapper">
        <div class="d4p-update-info">
            ...
            <div class="d4p-install-block">
                ...
                <div>
					<?php esc_html_e( 'Installation completed.', 'breadcrumbspress' ); ?>
                </div>
            </div>

            <div class="d4p-install-confirm">
                <a class="button-primary" href="<?php echo panel()->a()->panel_url( 'about' ) ?>&install"><?php esc_html_e( 'Click here to continue', 'breadcrumbspress' ); ?></a>
            </div>
        </div>
    </div>
</div>